app.service('GroupService', function ($http, $timeout) {
...
app.service('PostService', function($http) {
    ...
    return {
        createPost : function(opt, files, callback) {
            var url = APP.service.createGroupPost+"?access_token="+APP.accessToken;
            doPostPostOnGroupWithFile($http, url, opt, files, function(data) {
                callback(data);
            });
        },
...
app.service('CommentService', function($http) {
    ...
    return {
        createComment : function(opt, file, callback) {
